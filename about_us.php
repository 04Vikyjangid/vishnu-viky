...
<section>
    ...
    <div class="d-none d-md-block">
        <div class="d-flex justify-content-between align-items-center my-3">
            ...
            <img src="./media/images/home-pink-triangle-right.png" alt="home-pink-triangle-left" class="home-triangle">
        </div>
    </div>
</section>

<section id="about-who-are-we" class="mt-4">
    <div class="container-fluid px-2 px-md-5">
        <div class="row">
            <div class="col-12 col-md-6 text-center d-block d-md-none my-4">
...
<section id="about-why-us" class="mt-4">
    <div class="container-fluid px-2 px-md-5">
        <div class="row">
