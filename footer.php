    ...
    <div class="row">
            ...
            <h4 class="ff-Azonix footer-heading text-blue" style="text-align: left; margin-left:15px;">CONTACT US</h3>
                ...
                <div class="row  my-1">
                    ...
                    <div class="col-10">
                        <ul class="list-unstyled footer-ul">
                            <li class="text-white text-bold h6" style="float:left;">+91-9755953257<br>+91-8349196404<br>
                            </li>
                ...
                <div class="row my-1">
                    <div class="row my-1">
                        ...
                        <div class="col-10">
                            <ul class="list-unstyled footer-ul">
                                <li class="text-white text-bold" style="float: left;">Indore, Madhya Pradesh - INDIA
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12  px-5 text-white">
            ...
            <ul class="list-unstyled footer-ul">
                <li class="my-1" style="text-align: left;">
                    <a class="text-white text-bold text-decoration-none h6" href="./index.php">Home</a>
                </li>
                <li class="my-1" style="text-align: left;">
                    <a class="text-white text-bold text-decoration-none h6" href="./about_us.php">About Us</a>
                </li>
                <li class="my-1" style="text-align: left;">
                    <a class="text-white text-bold text-decoration-none h6" href="./services.php">Services</a>
                </li>
                <li class="my-1" style="text-align: left;">
                    <a class="text-white text-bold text-decoration-none h6" href="./contact_us.php">Contact Us</a>
                </li>
            </ul>
        </div>
        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 px-5">
            ...
            <ul class="list-unstyled footer-ul" style="text-align: left;">
                <li class="my-1">
                    <a href="https://www.facebook.com/LinkUsSolutions" target="blank"
                        class="text-decoration-none text-white"><img
                            src="./media/images/home-digitalPatner-socialIcon-2.png" alt="social icon"
                            class="social-icon m-1" style="width: 10px;"> &nbsp;&nbsp;Facebook</a>
                </li>
                <li class="my-1">

                    <a href="https://www.instagram.com/LinkUsSolutions" target="blank"
                        class="text-decoration-none text-white"><img
                            src="./media/images/home-digitalPatner-socialIcon-4.png" alt="social icon"
                            class="social-icon m-1" style="width: 20px;">
                        Instagram</a>
                </li>

                <li class="my-1">
                    <a href="https://www.linkedin.com/Linkussolutions" target="blank"
                        class="text-decoration-none text-white"><img
                ...
                <li class="my-1">
                    <a href="#" target="blank" class="text-decoration-none text-white"><img
                            src="./media/images/twitter-logo-4.png" alt="social icon" class="social-icon m-1"
                            style="width: 20px;">&nbsp;Twitter</a>
                </li>
                <li class="my-1">
                    <a href="https://wa.me/+919343092938" target="blank" class="text-decoration-none text-white"><img
                            src="./media/images/home-digitalPatner-socialIcon-1.png" alt="social icon"
                            class="social-icon m-1" style="width: 20px;">&nbsp;&nbsp;Whatsapp</a>
                </li>
            </ul>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12  px-5">
            ...
            <ul class="list-unstyled footer-ul" style="text-align: left;">
                <li class="my-1">
                    ...
                    <a class="text-white text-decoration-none h6" href="/services.php">RPO</a>
                ...
                <li class="my-1">
                    <a class="text-white text-decoration-none h6" href="/services.php">Payrol Handeling & Management</a>
                </li>
                <li class="my-1">
                    <a class="text-white text-decoration-none h6" href="/services.php">Training & Development</a>
                </li>
                <li class="my-1">
                    <a class="text-white text-decoration-none h6" href="/services.php">Counselling</a>
                </li>
                <li class="my-1">
                    <a class="text-white text-decoration-none h6" href="/services.php">Corporate Events</a>
                </li>
            </ul>
        </div>
    </div>
