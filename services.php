            ...
            <div class="tab-pane fade show active" id="nav-rpo" role="tabpanel" aria-labelledby="nav-rpo-tab">
                <div class="container">
                    <div class="tab-heading my-5 text-center">
                        ...
                        <h4 class="ff-raleway my-5">As RPO LinkUsSolution provides a company’s HR or Resource function
                            and placing people into the client's organization. We deliver staff, technology, and
                            methodology as per client's requirement.</h4>
                    </div>
                                            ...
                                            <div class="modal-content bg-black">
                                                ...
                                                <div class="modal-body" id="get-in-touch">
                                                    <div class="offset-md-2 col-12 col-md-8">
                                                        ...
                                                        <p>LinkUsSolution provides Talent Acquisition and here we deals
                                                            mostly with recruiting and onboarding. It includes
                                                            recruiting, tracking and interviewing job candidates, and
                                                            Zonboarding and training new employees.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="modal fade" id="rpo-sub-services-2" data-bs-backdrop="static"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content bg-black">
                                                ...
                                                <div class="modal-body" id="get-in-touch">
                                                    <div class="offset-md-2 col-12 col-md-8">
                                                        <h5 class="ff-anzonix primary-blue">Pre-Employment Screening
                                                        </h5>
                                                        <p>LinkUsSolution provides Pre-Employment screening which cater
                                                            the hiring process in order to eliminate a large number of
                                                            unsuitable applicants without the need for a traditional
                                                            interview.</p>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="modal fade" id="rpo-sub-services-3" data-bs-backdrop="static"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content bg-black">
                                                ...
                                                <div class="modal-body" id="get-in-touch">
                                                    <div class="offset-md-2 col-12 col-md-8">
                                                        <h5 class="ff-anzonix primary-blue">Early Career/Graduate
                                                            Recruitment</h5>
                                                        <p>LinkUsSolution providing the availability of Graduate
                                                            recruitment or campus recruitment whereby employers
                                                            undertake an organised program of attracting and hiring
                                                            students who are about to graduate from colleges, and
                                                            universities with less cost.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="modal fade" id="rpo-sub-services-4" data-bs-backdrop="static"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content bg-black">
                                                    ...
                                                    <div class="modal-body" id="get-in-touch">
                                                        <div class="offset-md-2 col-12 col-md-8">
                                                            <h5 class="ff-anzonix primary-blue">Overall Handling of HR
                                                            </h5>
                                                            <p>LinkUsSolution providing the Overall Handling of HR. As
                                                                we deal with the hiring, administration, and training of
                                                                staff. So whether new staff or old staff we cater all
                                                                needs as per requirements of our client.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="modal-content bg-black">
                                                    ...
                                                    <div class="modal-body" id="get-in-touch">
                                                        <div class="offset-md-2 col-12 col-md-8">
                                                            ...
                                                            <p>LinkUsSolution working for Talent Engagement as well,
                                                                where attracting the right people to your organisation
                                                                and getting candidates and employees to fully engage and
                                                                connect with your company's values, goals, and
                                                                principles.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="modal-content bg-black">
                                                ...
                                                <div class="modal-body" id="get-in-touch">
                                                    <div class="offset-md-2 col-12 col-md-8">
                                                        ...
                                                        <p>LinkUsSolution help to Build and maintain a healthy
                                                            relationship between employer and employee. For that we
                                                            recruits both active and passive candidates. Ultimately,
                                                            candidate management allows recruiters to make better
                                                            matches between candidates and clients. It further goes with
                                                            relationships that recruiters build with candidates & allow
                                                            them to develop a diverse pool of talent and to exercise
                                                            good judgment when putting candidates forward for job
                                                            vacancies. </p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="modal-content bg-black">
                                                ...
                                                <div class="modal-body" id="get-in-touch">
                                                    <div class="offset-md-2 col-12 col-md-8">
                                                        ...
                                                        <p>Performance management is a corporate management tool that
                                                            helps managers monitor and evaluate employees' work.
                                                            Performance management's goal is to create an environment
                                                            where people can perform to the best of their abilities to
                                            ...
                                            <div class="modal-content bg-black">
                                                ...
                                                <div class="modal-body" id="get-in-touch">
                                                    <div class="offset-md-2 col-12 col-md-8">
                                                        ...
                                                        <p>A performance appraisal is a regular review of an employee's
                            ...
                            <div class="row">
                                <div class="col-6 rpo-sub-services-9">
                                    <button type="button" class="btn rpo-sub-services-9-btn" data-bs-toggle="modal"
                                        ...
                                        <img src="./media/images/RPO/RPO/potential-appraisal-and-management.png"
                                            class="w-50">
                                    </button>
                                    <div class="modal fade" id="rpo-sub-services-9" data-bs-backdrop="static"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content bg-black">
                                                ...
                                                <div class="modal-body" id="get-in-touch">
                                                    <div class="offset-md-2 col-12 col-md-8">
                                                        <h5 class="ff-anzonix primary-blue">Potential Appraisal &
                                                            Management</h5>
                                                        <p>Potential appraisal is a future – oriented appraisal whose
                                                            main objective is to identify and evaluate the potential of
                                                            the employees to assume higher positions and
                                                            responsibilities in the organizational hierarchy.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="modal-content bg-black">
                                                ...
                                                <div class="modal-body" id="get-in-touch">
                                                    <div class="offset-md-2 col-12 col-md-8">
                                                        ...
                                                        <p>Competency Analysis is a tool used to measure knowledge,
                                                            skills, and capabilities either for analyzing a company's
                                                            products, services, human capital, or it can be used in
                                                            education in order to analyze the core competency in student
                                                            performance.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="modal-content bg-black">
                                                ...
                                                <div class="modal-body" id="get-in-touch">
                                                    <div class="offset-md-2 col-12 col-md-8">
                                                        ...
                                                        <p>Competency mapping is the process of identifying the specific
                                                            skills, knowledge, abilities, and behaviours required to
                                                            operate effectively in a specific trade, profession, or job
                                                            position. ... All of our competency maps are
                                                            all-encompassing, including professional, personal, and
                                            ...
                                            <div class="modal-content bg-black">
                                                ...
                                                <div class="modal-body" id="get-in-touch">
                                                    <div class="offset-md-2 col-12 col-md-8">
                                                        ...
                                                        <p>Performance Counseling refers to the help provided by a
                                                            manager to his subordinates in objectively analyzing their
                                                            performance. It attempts to help the employee in:
                                                            Understanding himself - his strengths and weaknesses.
                                                            Improving his professional and interpersonal competence by
                                                            giving him feedback about his behavior.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="modal-content bg-black">
                                                ...
                                                <div class="modal-body" id="get-in-touch">
                                                    <div class="offset-md-2 col-12 col-md-8">
                                                        ...
                                                        <p>Succession planning is a strategy for passing on leadership
                                                            roles—often the ownership of a company—to an employee or
                                                            group of employees. Also known as "replacement planning," it
                                                            ensures that businesses continue to run smoothly after a
                                                            company's most important people move on to new
                                                            opportunities, retire, or pass away.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="modal fade" id="rpo-sub-services-14" data-bs-backdrop="static"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content bg-black">
                                                ...
                                                <div class="modal-body" id="get-in-touch">
                                                    <div class="offset-md-2 col-12 col-md-8">
                                                        <h5 class="ff-anzonix primary-blue">Interventition Management
                                                        </h5>
                                                        <p>This research defines a management intervention as an
                                                            interaction between a manager. and employee. The interaction
                                                            could be initiated by either party and would generally
                                                            include some form of specific communication in one direction
                                                            or both.</p>
                                                    </div>
                                                </div>
                                            </div>
            ...
            <div class="tab-pane fade" id="nav-digital-marketing" role="tabpanel"
                ...
                <div class="container">
                    <div class="tab-heading my-5 text-center">
                        ...
                        <h4 class="ff-raleway my-5">As IT Solutions LinkUsSolution provides a set of related software
                            programs and/or services that are sold as a single package. LinkUs Solutions will provide
                            several different services that helps customers with the guidance and support needed to
                            maintain efficient and effective IT systems.
                        </h4>
                    </div>
                                            ...
                                            <div class="modal-content bg-black">
                                                ...
                                                <div class="modal-body" id="get-in-touch">
                                                    <div class="offset-md-2 col-12 col-md-8">
                                                        ...
                                                        <p>LinkUs Solutions is here to provide the general and in-depth
                                                            marketing expertise, brand analysis, and solutions for
                                                            successfully selling the products attaining the business
                                    ...
                                    <div class="modal fade" id="digital-sub-services-2" data-bs-backdrop="static"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content bg-black">
                                                ...
                                                <div class="modal-body" id="get-in-touch">
                                                    <div class="offset-md-2 col-12 col-md-8">
                                                        <h5 class="ff-anzonix primary-blue">Suggesting Marketing
                                                            Strategies</h5>
                                                        <p>LinkUs Solutions will help to make marketing strategy to a
                                                            client for reaching prospective consumers and turning them
                                                            into customers of their products or services. So LinkUs
                                                            Solutions is committed to make marketing strategies as it
                                                            contains the company’s value proposition, key brand
                                                            messaging, data on target customer demographics, and other
                                                            high-level elements.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="modal-content bg-black">
                                                ...
                                                <div class="modal-body" id="get-in-touch">
                                                    <div class="offset-md-2 col-12 col-md-8">
                                                        ...
                                                        <p>LinkUs Solutions will help their clients to get the
                                                            strategies and stages for launching a new product
                                                            effectively. And will also help to get through the
                                                            technologies which will be helpful in launching a new
                                                            product.</p>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="modal-content bg-black">
                                                    ...
                                                    <div class="modal-body" id="get-in-touch">
                                                        <div class="offset-md-2 col-12 col-md-8">
                                                            ...
                                                            <p>To save the client's time and efforts LinkUs Solution is
                                                                here to give them the service of Segmentation which
                                                                means is to divide the marketplace into parts, or
                                                                segments, which are definable, accessible, actionable,
                                                                and profitable and have a growth potential.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
            ...
            <div class="tab-pane fade" id="nav-pay-roll" role="tabpanel" aria-labelledby="nav-pay-roll-tab">
                <div class="container">
                    <div class="tab-heading my-5 text-center">
                        ...
                        <h4 class="ff-raleway my-5">If you are looking for the payroll management process, LinkUs
                            Solution is here to administrate a company's employee's financial records. This would
                                    ...
                                    <div class="modal fade" id="payroll-sub-services-1" data-bs-backdrop="static"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content bg-black">
                                                ...
                                                <div class="modal-body" id="get-in-touch">
                                                    <div class="offset-md-2 col-12 col-md-8">
                                                        <h5 class="ff-anzonix primary-blue">Payroll Software Providers
                                                        </h5>
                                                        <p>LinkUs Solutions taking the responsibility of payroll
                                                            management so we are also providing the software for payroll
                                                            management. Payroll software can help organizations of all
                                                            sizes to maintain compliance with tax laws and other
                                                            financial regulations with reduce costs. Therefore, an
                                                            application-based solution saves valuable time as editing of
                                                            existing payroll is simplified and semi-automated.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="modal-content bg-black">
                                                ...
                                                <div class="modal-body" id="get-in-touch">
                                                    <div class="offset-md-2 col-12 col-md-8">
                                                        ...
                                                        <p>In this process, LinkUs Solutions uses software applications
                                                            to record employee details and manage salaries, track hours,
                                                            manage to leave, bonuses, and deductions among other
                                                            functions of payroll management including financial records.
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="modal fade" id="payroll-sub-services-3" data-bs-backdrop="static"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content bg-black">
                                                ...
                                                <div class="modal-body" id="get-in-touch">
                                                    <div class="offset-md-2 col-12 col-md-8">
                                                        <h5 class="ff-anzonix primary-blue">Compensation & Reward
                                                            Management</h5>
                                                        <p>Compensation management, also known as wage and salary
                                                            administration, remuneration management, or reward
                                                            management, is concerned with designing and implementing a
                                                            total compensation package. Compensation is what employees
                                                            receive in exchange for their work.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="modal fade" id="payroll-sub-services-4" data-bs-backdrop="static"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content bg-black">
                                                    ...
                                                    <div class="modal-body" id="get-in-touch">
                                                        <div class="offset-md-2 col-12 col-md-8">
                                                            <h5 class="ff-anzonix primary-blue">Payroll Database
                                                                Management</h5>
                                                            <p>Proper management of the payroll database, accounting for
                                                                relevant factors, which include overtime, vacations, and
                                                                bonuses, can become quite tricky. Also, varying taxes
                                                                and deductions may apply to different staff. </p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
            ...
            <div class="tab-pane fade" id="nav-training" role="tabpanel" aria-labelledby="nav-nav-training-tab">
                <div class="container">
                    <div class="tab-heading my-5 text-center">
                        ...
                        <h4 class="ff-raleway my-5">Looking for enhancing your knowledge, skills and competencies? Look
                            no further than LinkUs Solutions. In today’s world full of competition, we at LinkUs aim at
                            nourishing the talent of not only individuals, but also the organisations. With best
                            practice knowledge, our training experts help our customers achieve workforce performance.
                        </h4>
                    </div>
                    <div class="digital-sub-services">
                        <div class="main-row-1">
                                    ...
                                    <div class="modal fade" id="training-sub-services-1" data-bs-backdrop="static"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content bg-black">
                                                ...
                                                <div class="modal-body" id="get-in-touch">
                                                    <div class="offset-md-2 col-12 col-md-8">
                                                        <h5 class="ff-anzonix primary-blue">Corporate Training to the
                                                            employer</h5>
                                                        <p>At LinkUs Solutions, we focus on empowering organizations to
                                                            reach optimal performance results. We are determined with
                                                            helping customers build training capacity and advance their
                                                            practices. Our professionals can assist your company with
                                                            the implementation of new processes and technology through
                                                            customized training solutions.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="modal-body" id="get-in-touch">
                                                    <div class="offset-md-2 col-12 col-md-8">
                                                        ...
                                                        <p>Training and developing an employee doesn’t simply help their
                                                            growth but pushes the company to grow as well. WE ARE HERE
                                                            TO DO IT FOR YOU! We at LinkUs, prepare the employee for the
                                                            current as well as future jobs, by providing them with
                                                            learning opportunities to increase their capacities, to
                                                            undertake more challenging and complex tasks. </p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="modal fade" id="training-sub-services-3" data-bs-backdrop="static"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content bg-black">
                                                ...
                                                <div class="modal-body" id="get-in-touch">
                                                    <div class="offset-md-2 col-12 col-md-8">
                                                        <h5 class="ff-anzonix primary-blue">Corporate Training to
                                                            students</h5>
                                                        <p>Corporate training helps students transition smoothly into
                                                            corporate life. If correct guidance and inputs are given at
                                                            the right time and the students are groomed properly, they
                                                            can easily grab good opportunities early and become
                                                            successful in their chosen career. LinkUs aims at helping
                                                            students gain enough confidence to work with different
                                                            people in teams and get over their inhibitions. </p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="modal fade" id="training-sub-services-4" data-bs-backdrop="static"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content bg-black">
                                                    ...
                                                    <div class="modal-body" id="get-in-touch">
                                                        <div class="offset-md-2 col-12 col-md-8">
                                                            <h5 class="ff-anzonix primary-blue">Training based on
                                                                enhancing soft skills and personality</h5>
                                                            <p>For Enhancing Soft Skills and Personality training LinkUs
                                                                Solutions will train our clients to develop qualities
                                                                like emotional intelligence, effective communication
                                                                skills, self-confidence, friendliness, etiquette, and
                                                                more. This will lead to the all-around development of
                                                                our clients.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="modal fade" id="training-sub-services-5" data-bs-backdrop="static"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content bg-black">
                                                    ...
                                                    <div class="modal-body" id="get-in-touch">
                                                        <div class="offset-md-2 col-12 col-md-8">
                                                            <h5 class="ff-anzonix primary-blue">Human Resource
                                                                Development Audit</h5>
                                                            <p>HRD audit is useful to achieve the organizational goal
                                                                and also is a vital tool which helps to assess the
                                                                effectiveness of HR functions of an organization and
                                                                helps company remain competitive.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
            ...
            <div class="tab-pane fade" id="nav-councelling" role="tabpanel" aria-labelledby="nav-councelling-tab">
                <div class="container">
                    <div class="tab-heading my-5 text-center">
                        ...
                        <h4 class="ff-raleway my-5">Facing job dissatisfaction? Confused about the right career path?
                            Then all you need is a counselling session from great professionals. From helping choose the
                            right course, college to choosing the right job, LinkUs Solutions is here for you!</h4>
                    </div>
                                            ...
                                            <div class="modal-content bg-black">
                                                ...
                                                <div class="modal-body" id="get-in-touch">
                                                    <div class="offset-md-2 col-12 col-md-8">
                                                        ...
                                                        <p>Only a few people can find it easy to strike the right
                                                            balance between home demands, personal care, and work
                                                            responsibilities. Most fail at it. At LinkUs, with job
                                                            counselling, we aim at developing the necessary skills in
                                                            them to make healthy lifestyle choices. Employee counselling
                                                            helps both the organization and the employee as motivated,
                                                            charged, and loyal employees will be the best brand
                                                            ambassadors for your brand and business.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="modal-content bg-black">
                                                ...
                                                <div class="modal-body" id="get-in-touch">
                                                    <div class="offset-md-2 col-12 col-md-8">
                                                        ...
                                                        <p>We at LinkUs offer personalized career counselling to
                                                            students. The students receive guidance from our
                                                            professional counsellors that provide expert advice on the
                                                            potentials, aptitude, motivations and skills.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
            ...
            <div class="tab-pane fade" id="nav-corporate-events" role="tabpanel"
                ...
                <div class="container">
                    <div class="tab-heading my-5 text-center">
                        ...
                        <h4 class="ff-raleway my-5">Stressing over planning and organising an event? We are here to take
                            away your stress! LinkUs Solutions is your one-stop event solutions provider that offers a
                            wide range of corporate event management and creative services.</h4>
                    </div>
                                    ...
                                    <div class="modal fade" id="corporate-sub-services-1" data-bs-backdrop="static"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content bg-black">
                                                ...
                                                <div class="modal-body" id="get-in-touch">
                                                    <div class="offset-md-2 col-12 col-md-8">
                                                        <h5 class="ff-anzonix primary-blue">Stress Management/ Stress
                                                            Busting Activity</h5>
                                                        <p>Stress naturally occurs in the workplace. It can cause
                                                            problems with concentration and teamwork and ultimately
                                                            productivity. We are here to make sure that you don’t have
                                                            to face such problems. We offer exciting activities to
                                                            lighten up the stress at the workplace. </p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="modal fade" id="corporate-sub-services-2" data-bs-backdrop="static"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content bg-black">
                                                ...
                                                <div class="modal-body" id="get-in-touch">
                                                    <div class="offset-md-2 col-12 col-md-8">
                                                        <h5 class="ff-anzonix primary-blue">Happiness Activities (To
                                                            increase happiness quotient)</h5>
                                                        <p>It’s hard to be creative and successful at work when we are
                                                            feeling negative and stressed. Therefore, it is necessary to
                                                            keep a happy and healthy workplace environment, and LinkUs
                                                            is here to help you with that. Our Happiness activities help
                                                            employees to increase optimism, boost brain function, and
                                                            build team trust through shared experiences.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="modal-content bg-black">
                                                ...
                                                <div class="modal-body" id="get-in-touch">
                                                    <div class="offset-md-2 col-12 col-md-8">
                                                        ...
                                                        <p>A lack of motivation is one of the key productivity killers
                                                            in the modern workplace. Thinking of how to motivate your
                                                            workforce? Leave that task to LinkUs! We are here with some
                                                            great engaging and motivating activities to make sure your
                                                            workforce productivity doesn’t get affected.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="modal-content bg-black">
                                                    ...
                                                    <div class="modal-body" id="get-in-touch">
                                                        <div class="offset-md-2 col-12 col-md-8">
                                                            ...
                                                            <p>Office stress is one of the main culprits harming
                                                                productivity and health at the workplace. But we are
                                                                here to take care of it. We at LinkUs offer activities
                                                                and exercises, which freshen up the employee’s mood and
                                                                give their mind some relaxation.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="modal fade" id="corporate-sub-services-5" data-bs-backdrop="static"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content bg-black">
                                                    ...
                                                    <div class="modal-body" id="get-in-touch">
                                                        <div class="offset-md-2 col-12 col-md-8">
                                                            <h5 class="ff-anzonix primary-blue">Ergonomics Exeercises
                                                            </h5>
                                                            <p>An average workday means sitting at a desk and computer
                                                                for eight or more hours. This type of work can lead to a
                                                                host of musculoskeletal problems such as back pain,
                                                                spinal disc hernias, neck and shoulder pain and more.
                                                                LinkUs Solutions offers Ergonomics Exercises which
                                                                removes risk factors that lead to musculoskeletal
                                                                injuries and allows for improved human performance and
                                                                productivity.</p>
                                                        </div>
                                                    </div>
                                                </div>
