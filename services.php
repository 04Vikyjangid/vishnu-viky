        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active" id="nav-rpo" role="tabpanel" aria-labelledby="nav-rpo-tab">
                <div class="container">
                    ...
                    <div class="rpo-services">
                        <ul class="honeycomb">
                            <li class="honeycomb-cell col-xs-6" data-bs-toggle="modal" data-bs-target="#rpo-sub-services-1">
                                <img class="honeycomb-cell_img" src="img/work-1.jpg">
                                <div class="ff-azonix honeycomb-cell_title ">TALENT AQUISITION</div>
                            </li>
                            <li class="honeycomb-cell col-xs-6 col-sm-6" data-bs-toggle="modal" data-bs-target="#rpo-sub-services-2">
                                <img class="honeycomb-cell_img" src="img/work-2.jpg">
                                <div class="honeycomb-cell_title ff-azonix">Graphic Design</div>
                            </li>
                            <li class="honeycomb-cell col-xs-6 col-sm-6" data-bs-toggle="modal" data-bs-target="#rpo-sub-services-3">
                                <img class="honeycomb-cell_img" src="img/work-3.jpg">
                                <div class="honeycomb-cell_title ff-azonix">Illustration</div>
                            </li>
                            <li class="honeycomb-cell col-xs-6 col-sm-6" data-bs-toggle="modal" data-bs-target="#rpo-sub-services-4">
                                <img class="honeycomb-cell_img" src="img/work-4.jpg">
                                <div class="honeycomb-cell_title ff-azonix">Motion Graphics</div>
                            </li>
                            <li class="honeycomb-cell col-xs-6 col-sm-6" data-bs-toggle="modal" data-bs-target="#rpo-sub-services-5">
                                <img class="honeycomb-cell_img" src="img/work-5.jpg">
                                <div class="honeycomb-cell_title ff-azonix">3D<small>Animation</small></div>
                            </li>
                            <li class="honeycomb-cell col-xs-6 col-sm-6" data-bs-toggle="modal" data-bs-target="#rpo-sub-services-6">
                                <img class="honeycomb-cell_img" src="img/work-6.jpg">
                                <div class="honeycomb-cell_title ff-azonix">Cinematic<small>4D</small></div>
                            </li>
                            <li class="honeycomb-cell col-xs-6 col-sm-6" data-bs-toggle="modal" data-bs-target="#rpo-sub-services-7">
                                <img class="honeycomb-cell_img" src="img/work-7.jpg">
                                <div class="honeycomb-cell_title ff-azonix">Share Design</div>
                            </li>
                            <li class="honeycomb-cell col-xs-6 col-sm-6" data-bs-toggle="modal" data-bs-target="#rpo-sub-services-8">
                                <img class="honeycomb-cell_img" src="img/work-8.jpg">
                                <div class="honeycomb-cell_title ff-azonix">Share Design</div>
                            </li>
                            <li class="honeycomb-cell col-xs-6 col-sm-6" data-bs-toggle="modal" data-bs-target="#rpo-sub-services-9">
                                <img class="honeycomb-cell_img" src="img/work-9.jpg">
                                <div class="honeycomb-cell_title ff-azonix">Share Design</div>
                            </li>
                            <li class="honeycomb-cell col-xs-6 col-sm-6" data-bs-toggle="modal" data-bs-target="#rpo-sub-services-10">
                                <img class="honeycomb-cell_img" src="img/work-10.jpg">
                                <div class="honeycomb-cell_title ff-azonix">Share Design</div>
                            </li>
                            <li class="honeycomb-cell col-xs-6 col-sm-6" data-bs-toggle="modal" data-bs-target="#rpo-sub-services-11">
                                <img class="honeycomb-cell_img" src="img/work-11.jpg">
                                <div class="honeycomb-cell_title ff-azonix">Share Design</div>
                            </li>
                            <li class="honeycomb-cell col-xs-6 col-sm-6" data-bs-toggle="modal" data-bs-target="#rpo-sub-services-12">
                                <img class="honeycomb-cell_img" src="img/work-12.jpg">
                                <div class="honeycomb-cell_title ff-azonix">Share Design</div>
                            </li>
                            <li class="honeycomb-cell col-xs-6 col-sm-6" data-bs-toggle="modal" data-bs-target="#rpo-sub-services-13">
                                <img class="honeycomb-cell_img" src="img/work-13.jpg">
                                <div class="honeycomb-cell_title ff-azonix">Share Design</div>
                            </li>
                            <li class="honeycomb-cell col-xs-6 col-sm-6" data-bs-toggle="modal" data-bs-target="#rpo-sub-services-14">
                                <img class="honeycomb-cell_img" src="img/work-14.jpg">
                                <div class="honeycomb-cell_title ff-azonix">Share Design</div>
                            </li>
                            <li class="honeycomb-cell col-xs-6 col-sm-6 honeycomb_Hidden">
                            </li>
                        </ul>
                    </div>
                    <div class="services-pop-up">
            ...
            <div class="tab-pane fade" id="nav-digital-marketing" role="tabpanel" aria-labelledby="nav-digital-marketing-tab">
                <div class="container">
                    ...
                    <div class="digital-services">
                        <ul class="honeycomb">
                            <li class="honeycomb-cell" data-bs-toggle="modal" data-bs-target="#digital-sub-services-1">
                                <img class="honeycomb-cell_img" src="img/work-1.jpg">
                                <div class="ff-azonix honeycomb-cell_title"><small>APPLICATION DEVELOPMENT</small></div>
                            </li>
                            <li class="honeycomb-cell" data-bs-toggle="modal" data-bs-target="#digital-sub-services-2">
                                <img class="honeycomb-cell_img" src="img/work-2.jpg">
                                <div class="honeycomb-cell_title ff-azonix"><small>DIGITAL MARKETING</small></div>
                            </li>
                            <li class="honeycomb-cell" data-bs-toggle="modal" data-bs-target="#digital-sub-services-3">
                                <img class="honeycomb-cell_img" src="img/work-3.jpg">
                                <div class="honeycomb-cell_title ff-azonix"><small>BRANDING</small></div>
                            </li>
                            <li class="honeycomb-cell" data-bs-toggle="modal" data-bs-target="#digital-sub-services-4">
                                <img class="honeycomb-cell_img" src="img/work-4.jpg">
                                <div class="honeycomb-cell_title ff-azonix"><small>SOFTWARE DEVELOPMENT</small></div>
                            </li>
                            <li class="honeycomb-cell" data-bs-toggle="modal" data-bs-target="#digital-sub-services-5">
                                <img class="honeycomb-cell_img" src="img/work-5.jpg">
                                <div class="honeycomb-cell_title ff-azonix"><small>WEBSITE DEVELOPMENT</small></div>
                            </li>
                            <li class="honeycomb-cell" data-bs-toggle="modal" data-bs-target="#digital-sub-services-6">
                                <img class="honeycomb-cell_img" src="img/work-5.jpg">
                                <div class="honeycomb-cell_title ff-azonix"><small>MERCHANDIZING</small></div>
                            </li>
                            <li class="honeycomb-cell" data-bs-toggle="modal" data-bs-target="#digital-sub-services-7">
                                <img class="honeycomb-cell_img" src="img/work-5.jpg">
                                <div class="honeycomb-cell_title ff-azonix"><small>GRAPHIC DESIGNING</small></div>
                            </li>
                            <li class="honeycomb-cell" data-bs-toggle="modal" data-bs-target="#digital-sub-services-8">
                                <img class="honeycomb-cell_img" src="img/work-5.jpg">
                                <div class="honeycomb-cell_title ff-azonix"><small>MEDIA & ANIMATION</small></div>
                            </li>
                            <li class="honeycomb-cell honeycomb_Hidden">
                            </li>
                        </ul>
                    </div>
                    <div class="digital-marketing-pop-up">
                        ...
                        <div class="modal fade" id="digital-sub-services-6" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content bg-black">
                                    <div class="modal-header">
                                        <button type="button" class="btn-close bg-white"
